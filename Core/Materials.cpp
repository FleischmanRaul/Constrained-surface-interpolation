...
//done:GLvoid SetDiffuseColor(GLenum face, GLfloat r, GLfloat g, GLfloat b, GLfloat a = 1.0f);
...
//done:GLvoid SetDiffuseColor(GLenum face, const Color4& c);
...
//done:GLvoid SetSpecularColor(GLenum face, GLfloat r, GLfloat g, GLfloat b, GLfloat a = 1.0f);
...
//done:GLvoid SetSpecularColor(GLenum face, const Color4& c);
...
//done:GLvoid SetEmissiveColor(GLenum face, GLfloat r, GLfloat g, GLfloat b, GLfloat a = 1.0f);
...
//done:GLvoid SetEmissiveColor(GLenum face, const Color4& c);
...
//done:GLvoid SetShininess(GLenum face, GLfloat shininess);
...
//done:GLvoid SetTransparency(GLfloat alpha);
...
//done:GLboolean IsTransparent() const;
GLboolean Material::IsTransparent() const
{
    return _front_ambient.a() == 0.0 &&  _front_diffuse.a() == 0.0 && _front_specular.a() == 0.0 && _front_emissive.a() == 0.0 &&
           _back_ambient.a() == 0.0 && _back_diffuse.a() ==0.0 && _back_specular.a() == 0.0 && _back_emissive.a() == 0.0;
}
GLvoid Material::Apply()
{
    glMaterialfv(GL_FRONT, GL_AMBIENT,   &_front_ambient.r());
    glMaterialfv(GL_FRONT, GL_DIFFUSE,   &_front_diffuse.r());
    glMaterialfv(GL_FRONT, GL_SPECULAR,  &_front_emissive.r());
